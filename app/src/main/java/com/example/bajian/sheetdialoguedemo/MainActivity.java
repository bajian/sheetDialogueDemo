package com.example.bajian.sheetdialoguedemo;
...
/**
 * 放qq 或者ios 底部弹出的列表型选择栏。打包成module了
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new SheetDialog(MainActivity.this)
                        .setTitle("请选择：")
                ...
                //addSheetItems 还可以用addSheetItem一个个add 自己测试了
            }
        });
    }
